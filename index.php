...
<!--datatable-->
  ...
  ?>
   ...
   <header id="header"><!--header-->
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +84 949800908</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> vuhai@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
		...
		<div class="header-middle" style="background-color:purple"><!--header-middle-->
			<div class="container" >
				<div>
					<div class="col-sm-6" >
						<div class="logo pull-left" >
                            <a href="index.php" style="background-color:#069;color:#FFF"> TOYS
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        ...
                        <p>A toy or plaything is an object that is used primarily to provide entertainment. Simple examples include toy blocks, board games, and dolls. Toys are often designed for use by children, although many are designed specifically for adults and pets.</p>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                        <h2 class="footer-wid-title">Product</h2>
                        <ul>
                            <li><a href="#">Toys</a></li>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-newsletter">
                        ...
                        <p>Sign up for maintenance support when the product has a problem.</p>
                        <div class="newsletter-form">
                            <form action="#">
                                <input type="email" placeholder="Enter email or number phone">
